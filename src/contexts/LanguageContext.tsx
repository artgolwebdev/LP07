...
function getTranslations(language: Language): Record<string, string> {
  const translations = {
    en: {
      ...
      'booking.lets-start': "Please provide your contact details",
      ...
      'booking.telegram-placeholder': '@yourusername',
      ...
      'booking.telegram-field': 'Telegram',
    ...
    ru: {
      ...
      'booking.lets-start': 'Пожалуйста, предоставьте ваши контактные данные',
      ...
      'booking.telegram': 'Telegram Handle',
      'booking.telegram-placeholder': '@вашusername',
      ...
      'booking.book-again': 'Забронировать снова',
    ...
    fr: {
      ...
      'booking.lets-start': 'Veuillez fournir vos coordonnées',
      ...
      'booking.telegram': 'Telegram Handle',
      'booking.telegram-placeholder': '@votrenom',
      ...
      'booking.book-again': 'Réserver à nouveau',
    ...
    he: {
      ...
      'booking.lets-start': 'אנא ספק את פרטי הקשר שלך',
      ...
      'booking.instagram': 'אינסטגרם',
      'booking.instagram-placeholder': '@yourusername',
      'booking.telegram': 'טלגרם',
      'booking.telegram-placeholder': '@yourusername',
